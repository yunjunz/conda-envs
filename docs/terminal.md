...
__conda_setup="$('/Users/yunjunz/tools/miniforge/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/yunjunz/tools/miniforge/etc/profile.d/conda.sh" ]; then
        . "/Users/yunjunz/tools/miniforge/etc/profile.d/conda.sh"
    else
        export PATH="/Users/yunjunz/tools/miniforge/bin:$PATH"
    fi
fi
unset __conda_setup

if [ -f "/Users/yunjunz/tools/miniforge/etc/profile.d/mamba.sh" ]; then
    . "/Users/yunjunz/tools/miniforge/etc/profile.d/mamba.sh"
fi
# <<< conda initialize <<<
...
alias load_fringe='conda activate fringe; source ~/tools/conda-envs/fringe/config.rc'
